...
## Call-duration update — 2026-09-19

The owner requested matching the website to the 15-minute Cal.com event they had already changed. The public event and description both show 15 minutes, independently verified on this date. Only the shared call-duration setting and corresponding documentation/claim entries change; the September 17 research and lab reports above remain historical records. The call length is an owner decision, not a vendor capability or conversion claim.
